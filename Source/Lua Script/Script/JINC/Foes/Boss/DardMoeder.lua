...
Data.ActMinLevel["Sys.Attack"] = 0		for ak=1,20 do table.insert(Data.Acts,"Sys.Attack") end
...
temp = { ITM='ITM_EQP_EMERALD', LVL=35, VLT=true }
...
temp = { ITM='ITM_EQP_RUBY', LVL=35, VLT=true }
...
for ak=1,20 do table.insert(Data.ItemSteal,temp) end
temp = { ITM='ITM_HEALINGCAPSULE', LVL=40, VLT=false }
...
temp = { ITM='ITM_PHAN_LEVELAPPLE', LVL=60, VLT=false }
for ak=1,60 do table.insert(Data.ItemDrop ,temp) end
for ak=1,60 do table.insert(Data.ItemSteal,temp) end
Data.ActMinLevel["Abl.ITM_SPORES"] = 5		for ak=1,5 do table.insert(Data.Acts,"Abl.ITM_SPORES") end
