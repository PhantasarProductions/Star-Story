...
Data = {
	Name = "Gremlin",
	Desc = "They like to lurk around in mines.\nMany miners on Phantasar found \nan early grave thanks to these\nnasty fellows.",
	ImageFile = "Reg/Gremlin.png",
	AI = "Default",
	Shilders = 500,
	EleRes_Fire = 3,
	EleRes_Wind = 3,
...
Data.ActMinLevel["Abl.ABL_EXHURU_CONCENTRATE"] = 10		for ak=1,2800 do table.insert(Data.Acts,"Abl.ABL_EXHURU_CONCENTRATE") end
