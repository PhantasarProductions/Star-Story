...
Data = {
	Name = "Confusion Gun",
	Desc = "",
	ImageFile = "Goddess/Add_ConfuseGun.png",
	AI = "Default",
	Boss = true,
	EleRes_Fire = 5,
	EleRes_Wind = 5,
...
Data.ActMinLevel["Abl.ZZZZ_ADD_GODDESS_CONFUSHOT"] = 5		for ak=1,5 do table.insert(Data.Acts,"Abl.ZZZZ_ADD_GODDESS_CONFUSHOT") end
