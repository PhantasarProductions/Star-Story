...
ret = {
        ...
        ['00000938'] = { txt = 'TheSkull', r=0,g=180,b=255, y=2360 },
        ['0000094C'] = { txt = 'Tibetan_Fox', r=0,g=180,b=255, y=2380 },
        ['00000960'] = { txt = 'Unknown Artist', r=0,g=180,b=255, y=2400 },
        ['00000974'] = { txt = 'Vicious_Speed', r=0,g=180,b=255, y=2420 },
        ['00000988'] = { txt = 'Vickie', r=0,g=180,b=255, y=2440 },
        ['0000099C'] = { txt = 'YADOT', r=0,g=180,b=255, y=2460 },
        ['000009B0'] = { txt = 'barnheartowl', r=0,g=180,b=255, y=2480 },
        ['000009C4'] = { txt = 'burnurb', r=0,g=180,b=255, y=2500 },
        ['000009D8'] = { txt = 'cgbug', r=0,g=180,b=255, y=2520 },
        ['000009EC'] = { txt = 'eady', r=0,g=180,b=255, y=2540 },
        ['00000A00'] = { txt = 'finao123', r=0,g=180,b=255, y=2560 },
        ['00000A14'] = { txt = 'foofurple', r=0,g=180,b=255, y=2580 },
        ['00000A28'] = { txt = 'glitch', r=0,g=180,b=255, y=2600 },
        ['00000A3C'] = { txt = 'hatalar205', r=0,g=180,b=255, y=2620 },
        ['00000A50'] = { txt = 'jonata', r=0,g=180,b=255, y=2640 },
        ['00000A64'] = { txt = 'jpd2010', r=0,g=180,b=255, y=2660 },
        ['00000A78'] = { txt = 'jphandrigan', r=0,g=180,b=255, y=2680 },
        ['00000A8C'] = { txt = 'kg', r=0,g=180,b=255, y=2700 },
        ['00000AA0'] = { txt = 'pitr', r=0,g=180,b=255, y=2720 },
        ['00000AB4'] = { txt = 'qubodub', r=0,g=180,b=255, y=2740 },
        ['00000AC8'] = { txt = 'tzunghaor', r=0,g=180,b=255, y=2760 },
        ['00000ADC'] = { txt = 'wallpaperpal.com', r=0,g=180,b=255, y=2780 },
        ['00000AF0'] = { txt = 'warszawianka', r=0,g=180,b=255, y=2800 },
        ['00000B18'] = { txt = 'Map Design', r=255,g=0,b=0, y=2840 }, -- Map Design
        ['00000B2C'] = { txt = 'Jeroen Broks', r=0,g=180,b=255, y=2860 },
        ['00000B54'] = { txt = 'Music', r=255,g=0,b=0, y=2900 }, -- Music
        ['00000B68'] = { txt = 'Aaron Krogh', r=0,g=180,b=255, y=2920 },
        ['00000B7C'] = { txt = 'Alexander', r=0,g=180,b=255, y=2940 },
        ['00000B90'] = { txt = 'Brian Boyko', r=0,g=180,b=255, y=2960 },
        ['00000BA4'] = { txt = 'Eric Matyas', r=0,g=180,b=255, y=2980 },
        ['00000BB8'] = { txt = 'Fake Music Generator', r=0,g=180,b=255, y=3000 },
        ['00000BCC'] = { txt = 'J.W.H. Broeders', r=0,g=180,b=255, y=3020 },
        ['00000BE0'] = { txt = 'Jeroen Broks', r=0,g=180,b=255, y=3040 },
        ['00000BF4'] = { txt = 'Kevin McLeod', r=0,g=180,b=255, y=3060 },
        ['00000C08'] = { txt = 'Knight Of Fire', r=0,g=180,b=255, y=3080 },
        ['00000C1C'] = { txt = 'Lee Rosevere', r=0,g=180,b=255, y=3100 },
        ['00000C30'] = { txt = 'Matt McFarland', r=0,g=180,b=255, y=3120 },
        ['00000C44'] = { txt = 'Rockit Maxx', r=0,g=180,b=255, y=3140 },
        ['00000C58'] = { txt = 'SJ Mellia', r=0,g=180,b=255, y=3160 },
        ['00000C6C'] = { txt = 'Sergey Cheremisinov', r=0,g=180,b=255, y=3180 },
        ['00000C80'] = { txt = 'Spiedkiks', r=0,g=180,b=255, y=3200 },
        ['00000C94'] = { txt = 'Wan Kee Chan & Wouter Wershkull', r=0,g=180,b=255, y=3220 },
        ['00000CA8'] = { txt = 'WeirdoMusic', r=0,g=180,b=255, y=3240 },
        ['00000CBC'] = { txt = 'Widzy', r=0,g=180,b=255, y=3260 },
        ['00000CD0'] = { txt = 'Your Marginally Talented Photographer Girlfriend', r=0,g=180,b=255, y=3280 },
        ['00000CF8'] = { txt = 'Scenario', r=255,g=0,b=0, y=3320 }, -- Scenario
        ['00000D0C'] = { txt = 'Jeroen Broks', r=0,g=180,b=255, y=3340 },
        ['00000D34'] = { txt = 'Script', r=255,g=0,b=0, y=3380 }, -- Script
        ['00000D48'] = { txt = 'Jeroen Broks', r=0,g=180,b=255, y=3400 },
        ['00000FA0'] = { txt = '(c) Copyright 2016', r=255, g=180,b=0,y=4000},
        ['00000FB9'] = { txt = 'Jeroen Petrus Broks', r=255, g=180,b=0,y=4025}
}
