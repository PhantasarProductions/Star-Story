...
local crystal = Image.Load("GFX/Combat/SpellAni/SuperMoves/SkyDragonSlash.png"); Image.HotCenter(crystal)
local screen  = Image.GrabScreen()
repeat
if qr<10  then qr = qr + .01 end
if al<100 then al = al + .5 end
qm = qm * - 1
White()
Image.Cls()
