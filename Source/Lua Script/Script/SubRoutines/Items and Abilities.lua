...
local vmax = Sys.Val(max or Image.Height(itemicons[i]))
local scale
if max and vmax>0 and Image.Height(itemicons[i])>vmax then
   scale = (vmax/Image.Height(itemicons[i]))*100
   Image.ScalePC(scale,scale)
   end   
