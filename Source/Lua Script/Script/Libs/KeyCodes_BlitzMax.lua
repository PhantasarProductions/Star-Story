--[[
    ...
    This file has been a litteral translation from the KeyCodes module in BlitzMax to Lua
    Therefore I deem this fill still (C) Blitz Research Ltd and as they licensed the file
    under the zlib license this Lua translation will remain the same way.
